...
correction_limit = 0.4  # Max correction (increased for sharper turns)
min_speed = 0.05        # Minimum speed (lowered to allow bigger speed differential)
...
try:
    while True:
        ...
        print(f"Lux: {luxSample:6.1f} | Error: {error:6.1f} | "
              f"L: {left_power:5.2f} R: {right_power:5.2f}")
